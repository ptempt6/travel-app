...
public class RouteService {
    ...
    public RouteService(RouteRepository routeRepository, UserRepository userRepository, PlaceRepository placeRepository, RouteMapper routeMapper) {
    ...
    public RouteResponseDto createRoute(RouteRequestDto dto) {
        User author = userRepository.findById(dto.getAuthorId()).orElseThrow(() -> new RuntimeException("User not found"));
