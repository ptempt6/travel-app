...
public class RouteController {
    ...
    public ResponseEntity<Void> addPlaceToRoute(@PathVariable Long routeId, @PathVariable Long placeId) {
        routeService.addPlaceToRoute(routeId, placeId);
        return ResponseEntity.noContent().build();
    }

    @PutMapping("/{id}")
    public ResponseEntity<RouteResponseDto> updateRoute(@PathVariable Long id, @RequestBody RouteRequestDto dto) {
